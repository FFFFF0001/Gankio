...
/**
 * Created by JW.Xuan on 2016/8/24 16:19.
 * 邮箱：mifind@sina.com
 */
public class RestFragment extends BaseGankFragment {
    ...
    protected void RequestData() {
        RequestManager.getInstance().debug("request").get("all", Conf.RequestRest(pageSize, page), true, new ICallBack<List<GankModel>>() {
