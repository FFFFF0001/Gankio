 ...
 * 邮箱：mifind@sina.com
 */
public class ExpandFragment extends BaseGankFragment {
    public static final String TAG = ExpandFragment.class.getSimpleName();
    ...
    protected void RequestData() {
        RequestManager.getInstance().debug("request").get("all", Conf.RequestExpand(pageSize, page), true, new ICallBack<List<GankModel>>() {
